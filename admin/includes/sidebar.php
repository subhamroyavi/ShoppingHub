    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2"> <!--begin::Sidebar Menu-->
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="registered_user.php" class="nav-link"> <i class="nav-icon bi bi-palette"></i>
                        <p>Registered User</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="categories.php" class="nav-link"> <i class="nav-icon bi bi-palette"></i>
                        <p>Categories</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="products.php" class="nav-link"> <i class="nav-icon bi bi-palette"></i>
                        <p>Products</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="carousel.php" class="nav-link"> <i class="nav-icon bi bi-palette"></i>
                        <p>Carousel</p>
                    </a>
                </li>
